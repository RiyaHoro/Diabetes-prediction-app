      ...
      <div className="container px-6 mx-auto max-w-7xl md:px-12">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="mt-4 text-xl text-gray-700">
            Learn more about the global impact of diabetes and the accuracy of
        ...
        <div className="grid gap-6 mb-10 md:grid-cols-2">
          ...
          <div className="p-8 bg-white border-2 border-blue-500 rounded-lg shadow-lg">
            ...
            <p className="mb-4 text-lg text-gray-700">
              The number of people living with diabetes has been increasing
              globally. Below is a bar chart showing the number of people
              diagnosed with diabetes from 2010 to 2020.
            </p>
            ...
            <p className="mt-4 text-sm text-gray-600">
              Source: World Health Organization (WHO) Global Report on Diabetes,
              2021.
            </p>
          </div>
          ...
          <div className="p-8 bg-white border-2 border-blue-500 rounded-lg shadow-lg">
            ...
            <p className="mb-4 text-lg text-gray-700">
              Our diabetes prediction model has been trained and evaluated for
            ...
            <div className="p-6 text-center bg-blue-100 border-2 border-blue-500 rounded-lg">
              ...
              <p className="text-lg text-gray-700">
                Our model performs with {modelAccuracy}% accuracy in predicting
                diabetes risk.
              </p>
            </div>
          </div>
        ...
        <div className="p-8 mb-10 bg-white border-2 border-blue-500 rounded-lg shadow-lg">
          ...
          <p className="mb-4 text-xl text-gray-700">
            If you're at risk of diabetes or already diagnosed, there are
            several health measures you can take to manage the condition and
            prevent complications. Here's a guide to help you stay healthy:
          </p>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="text-center">
              <img
                src={healthy}
                alt="Healthy Diet"
                className="object-cover w-48 h-48 mx-auto mb-4 rounded-full shadow-lg"
              />
              <h4 className="mb-2 text-2xl font-semibold text-blue-600">
                Healthy Diet
              </h4>
              <p className="text-lg text-gray-700">
                A balanced diet rich in vegetables, whole grains, and lean
                proteins is essential for managing diabetes.
              </p>
            </div>
            <div className="text-center">
              <img
              ...
              <p className="text-lg text-gray-700">
                Aim for at least 30 minutes of physical activity most days to
            ...
            <div className="text-center">
              ...
              <p className="text-lg text-gray-700">
                Regularly check your blood sugar levels to ensure they remain in
                a healthy range.
              </p>
            </div>
          </div>
          ...
          <div className="grid gap-8 mt-8 md:grid-cols-3">
            <div className="text-center">
              ...
              <p className="text-lg text-gray-700">
                Losing even a small amount of weight can improve blood sugar
            ...
            <div className="text-center">
              ...
              <p className="text-lg text-gray-700">
                Regular consultations with doctors can help ensure proper
            ...
            <div className="text-center">
              ...
              <p className="text-lg text-gray-700">
                Regular movement and physical activity help prevent diabetes
